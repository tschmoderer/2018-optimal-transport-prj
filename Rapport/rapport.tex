...
\newcommand\titre{Théorie du Transport Optimal\\Étude et Applications}
...
La continuité des $\prox$ entraînant celle de $F$, la suite $y_n$ converge 
...
\end{proposition}
\begin{preuve}
C'est essentiellement la même que celle de la proposition \eqref{prop:proxJ}.
\end{preuve}
...
Reprenons nos deux braves gaussiennes du premier exemple, et regardons l'effete du paramètre $\beta$ sur le transport. 
\begin{figure}[!h]
\centering 
	\begin{subfigure}[b]{0.48\linewidth}
